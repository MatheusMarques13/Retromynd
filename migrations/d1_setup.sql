-- RetroMynd D1 setup (cole isto inteiro no Console do D1 no painel da Cloudflare).
-- Cria todas as tabelas + dados de seed (badges/rewards) + a tabela de usuarios com os 3 usuarios.
